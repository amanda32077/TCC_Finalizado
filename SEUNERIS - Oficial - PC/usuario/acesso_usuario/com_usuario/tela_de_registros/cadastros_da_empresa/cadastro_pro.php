...
<body style="background-color: #ececf6; font-family:'Times New Roman', Times, serif;">
    <div class="container col-md-6">
        <div class="card" style="margin-top: 10%; width=10%;">
                        ...
                        <div class="card-body">
                            <form action="../../../../../sql/cadastros_da_empresa/cadastro_pro.php" method="post" novalidate="novalidate">
                            <input type="hidden" name="idempresa" value="<?php echo $idempresa?>">
                                ...
                                <div class="row col-md-12">
                                    <div class="col-4" >
                                      <label for="preco" class="control-label mb-1">Preço</label>
                                        <div class="input-group">
                                            <input  name="preco" type="number" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                    ...
                                    <div class="col-4" >
                                        ...
                                        <div class="input-group">
                                            <input  name="quantidade" type="number" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-4" >
                                        ...
                                        <div class="input-group">
                                            <input  name="codigo_de_venda" type="number" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                        </div>
                                    </div>
